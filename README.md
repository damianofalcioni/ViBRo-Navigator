...
**ViBRo Navigator** (**Vi**brating/**Vi**be-coded **BRo**uter **Navigator**) is a lightweight, offline-first, and battery-efficient Android GPS navigation app built on top of BRouter. It is designed for **map-free navigation**, delivering directions through **vibrations and minimal on-screen and voice guidance**, enabling distraction-free and screen-off usage.
