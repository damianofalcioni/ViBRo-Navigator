...
final class BRouterRd5StreetTags {
    ...
    static {
        ...
        ROUTE_TYPES[ROUTE_FERRY] = CompassStreetType.SPECIAL_ROUTE;
        ROUTE_TYPES[ROUTE_HIKING_FOOT] = CompassStreetType.ROUTE_WALKING_CYCLING;
        ROUTE_TYPES[ROUTE_BICYCLE] = CompassStreetType.ROUTE_WALKING_CYCLING;
        ROUTE_TYPES[ROUTE_SKI_PISTE] = CompassStreetType.SPECIAL_ROUTE;
        ROUTE_TYPES[ROUTE_MTB] = CompassStreetType.ROUTE_WALKING_CYCLING;
        ROUTE_TYPES[ROUTE_CANOE] = CompassStreetType.SPECIAL_ROUTE;
        ROUTE_TYPES[ROUTE_BUS] = CompassStreetType.SPECIAL_ROUTE;
    }
