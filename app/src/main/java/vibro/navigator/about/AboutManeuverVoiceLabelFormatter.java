...
final class AboutManeuverVoiceLabelFormatter {
    private static final String FEMALE_TOKEN = "female";
    private static final String MALE_TOKEN = "male";

    private AboutManeuverVoiceLabelFormatter() {
    }

    @NonNull
    static String format(@NonNull Context context, @NonNull Voice voice) {
    ...
    private static String formatVariantLabel(@NonNull Context context, @NonNull String voiceName) {
        AboutManeuverVoiceNameParser.VoiceVariant variant =
                AboutManeuverVoiceNameParser.extractVariant(voiceName);
