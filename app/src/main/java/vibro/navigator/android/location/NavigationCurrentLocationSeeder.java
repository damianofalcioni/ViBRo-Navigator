...
public final class NavigationCurrentLocationSeeder {
    ...
    public NavigationCurrentLocationSeeder(
    ...
    public void requestSeeds(boolean fineGranted, boolean coarseGranted) {
