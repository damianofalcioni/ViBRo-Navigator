...
public final class NavigationServiceCommandHandler {

    public interface NavigationRequestReader {
    ...
    public NavigationServiceCommandHandler(
    ...
    public int handle(@Nullable Intent intent, int flags, int startId) {
