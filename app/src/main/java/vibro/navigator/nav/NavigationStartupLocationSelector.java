...
final class NavigationStartupLocationSelector {
    ...
    @Nullable
    static Location selectBest(@Nullable Location gps, @Nullable Location network, long nowMs) {
        Location best = null;
    ...
    static boolean isUsable(@Nullable Location location, long nowMs) {
        if (location == null) {
            return false;
        }
