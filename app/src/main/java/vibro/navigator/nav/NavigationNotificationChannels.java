...
final class NavigationNotificationChannels {
    ...
    static void ensure(@NonNull Context context) {
    ...
    @NonNull
    static long[] genericAlertVibrationPattern() {
        return new long[]{0, 140, 90, 140};
    }

    @NonNull
    static long[] leftVibrationPattern() {
        return new long[]{0, 80, 80, 220};
    }

    @NonNull
    static long[] rightVibrationPattern() {
