...
final class NavigationGpsDetailsDialog {
    ...
    void show(@Nullable NavState state) {
        ...
        createdDialog.setTitle(R.string.title_nav_gps_details);
    ...
    void update(@Nullable NavState state) {
        TextView target = detailsText;
        if (target == null) {
            return;
        }
        NavState detailsState = state == null ? NavStateComposer.waiting(activity) : state;
        target.setText(NavigationGpsTelemetryFormatter.formatDetails(
                activity,
    ...
    private TextView createTitle() {
        ...
        title.setText(R.string.title_nav_gps_details);
