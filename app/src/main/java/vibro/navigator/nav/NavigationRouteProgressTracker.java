...
final class NavigationRouteProgressTracker {
    ...
    double rememberAndResolveSmoothedAccuracyMeters(float accuracyMeters, long nowMs) {
    ...
    @NonNull
    DirectionAssessment assessDirection(double alongTrackMeters, long nowMs) {
    ...
    void rememberAlongTrackSample(double alongTrackMeters, long nowMs) {
    ...
    static final class DirectionAssessment {
        @NonNull
        ...
        @NonNull
        static DirectionAssessment unknown() {
            return new DirectionAssessment(DirectionStatus.UNKNOWN, 0.0);
        }

        @NonNull
        static DirectionAssessment forward(double alongTrackDeltaMeters) {
            return new DirectionAssessment(DirectionStatus.FORWARD, alongTrackDeltaMeters);
        }

        @NonNull
        static DirectionAssessment backward(double alongTrackDeltaMeters) {
            return new DirectionAssessment(DirectionStatus.BACKWARD, alongTrackDeltaMeters);
        }

        @NonNull
        static DirectionAssessment stalled(double alongTrackDeltaMeters) {
