...
final class CompassRadiusResolver {
    ...
    static float movingLegendReferenceSpeedMps(float visibleRadiusMeters) {
        return movingLegendReferenceSpeedMps(visibleRadiusMeters, MIN_VISIBLE_RADIUS_METERS);
    }

    static float movingLegendReferenceSpeedMps(float visibleRadiusMeters, float fallbackRadiusMeters) {
