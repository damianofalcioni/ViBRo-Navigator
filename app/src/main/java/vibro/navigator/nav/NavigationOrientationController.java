...
final class NavigationOrientationController {

    interface CompassUiState {
    ...
    NavigationOrientationController(
    ...
    void maybeSendStationaryOrientationNotification(
    ...
    @Nullable
    Double currentDisplayHeadingDegrees() {
    ...
    @Nullable
    Float currentDisplayHeadingAccuracyDegrees() {
