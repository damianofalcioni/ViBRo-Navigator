...
public class NavigationForegroundControllerTest {
    ...
    public void ensureChannelsCreatesSilentDirectionalChannelsAndRemovesLegacyIds() {
        ...
        notificationManager.createNotificationChannel(new NotificationChannel(
                "vibenavigator.turn.left",
                "Legacy left",
                NotificationManager.IMPORTANCE_HIGH
        ));
        notificationManager.createNotificationChannel(new NotificationChannel(
                "vibenavigator.turn.right",
                "Legacy right",
                NotificationManager.IMPORTANCE_HIGH
        ));
        ...
        assertNull(notificationManager.getNotificationChannel("vibenavigator.turn.left"));
        assertNull(notificationManager.getNotificationChannel("vibenavigator.turn.right"));
