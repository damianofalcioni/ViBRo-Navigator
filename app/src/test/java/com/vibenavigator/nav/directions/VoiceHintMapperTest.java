...
public class VoiceHintMapperTest {
    ...
    public void mapsAllMode9JsonCodes() {
        assertDirection(1, 0, DirectionKind.STRAIGHT, R.string.direction_continue, 0, "⬆️");
        assertDirection(2, 0, DirectionKind.LEFT, R.string.direction_turn_left, 0, "⬅️");
        assertDirection(3, 0, DirectionKind.LEFT, R.string.direction_slight_left, 0, "↖️");
        assertDirection(4, 0, DirectionKind.LEFT, R.string.direction_sharp_left, 0, "⤺");
        assertDirection(5, 0, DirectionKind.RIGHT, R.string.direction_turn_right, 0, "➡️");
        assertDirection(6, 0, DirectionKind.RIGHT, R.string.direction_slight_right, 0, "↗️");
        assertDirection(7, 0, DirectionKind.RIGHT, R.string.direction_sharp_right, 0, "⤻");
        assertDirection(8, 0, DirectionKind.LEFT, R.string.direction_keep_left, 0, "↖️");
        assertDirection(9, 0, DirectionKind.RIGHT, R.string.direction_keep_right, 0, "↗️");
        assertDirection(10, 0, DirectionKind.LEFT, R.string.direction_uturn_left, 0, "↩️");
        assertDirection(11, 0, DirectionKind.RIGHT, R.string.direction_uturn_right, 0, "↪️");
